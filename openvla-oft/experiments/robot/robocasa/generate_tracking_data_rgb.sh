...
#     --align_forward_to_neg_x
    # --point_cloud_dir /scratch2/jisoo6687/robocasa/datasets/pointrack/kitchen_pnp/PnPStoveToCounter/2024-05-01 /
python ./generate_tracking_data_rgb.py \
    --dataset "/scratch2/jisoo6687/robocasa/datasets/single_stage/kitchen_doors/CloseDoubleDoor/2024-04-29/demo_gentex_im128_randcams.hdf5" \
    --point_cloud_dir /scratch2/whwjdqls99/robocasa/temp_v1 \
    --cube_half 0.6 \
    --anchor_body robot0_link0 \
    --max_track_points 1024 \
    --exclude_wall \
