#!/bin/bash
#SBATCH --job-name=ptw10_8192_blocks3
#SBATCH --nodes=1
...
torchrun --standalone --nnodes 1 --nproc-per-node 8 vla-scripts/finetune.py \
  ...
  --lora_rank 32 \
  --use_wandb False \
  --run_id_note track_5000_w10_hidden8192_blocks3-parallel_dec--8_acts_chunk--continuous_acts--L1_regression--3rd_person_img--proprio_state \
  --use_tensorboard True \
  --tensorboard_log_dir /home/jisookim/openvla-oft/runs/tensorboard_track_5000_w10_hidden8192_blocks3 \
  --run_root_dir /mnt/data/jisookim/openvla_finetune/track_5000_w10_hidden8192_blocks3 \
