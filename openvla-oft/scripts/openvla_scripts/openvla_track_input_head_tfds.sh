...
torchrun --standalone --nnodes 1 --nproc-per-node 4 vla-scripts/finetune_libero.py \
  ...
  --precomputed_statistics_path /scratch2/jisoo6687/libero/libero_goal_no_noops_track/libero_goal_statistics.json \
  --use_tracking_head True \
  ...
  --run_id_note track_5000_input_head_onlytrack_w10_new_data_hidden8192_blocks3-parallel_dec--8_acts_chunk--continuous_acts--L1_regression--3rd_person_img--proprio_state \
  --use_tensorboard True \
  --tensorboard_log_dir /scratch2/jisoo6687/openvla-oft/runs/tensorboard_track_4096_input_head_onlytrack_w10_new_data_hidden8192_blocks3 \
  --run_root_dir /scratch2/jisoo6687/openvla_finetune/track_4096_input_head_onlytrack_w10_new_data_hidden8192_blocks3 \
  --tracking_tracks_root /scratch2/jisoo6687/libero/pointrack/goal \
  ...
  --tracking_viz_dir /scratch2/jisoo6687/openvla_finetune/track_4096_input_head_onlytrack_w10_new_data_hidden8192_blocks3/videos \
  --tracking_loss_weight 10.0 \
  --tracking_dim 3 \
  --tracking_num_points 4096 \
  --pointcloud_input_num_points 4096 \
  --pointcloud_input_dim 3 \
  --grad_accumulation_steps 4 \
  --use_wandb True \
  --wandb_entity jiiiisoo \
  --wandb_project libero-vla-tracking \
  --run_id_note track_4096_input_head_onlytrack_w10_new_data_hidden8192_blocks3-parallel_dec--8_acts_chunk--continuous_acts--L1_regression--3rd_person_img--proprio_state \
