...
class DiffusionPolicyConfig(BaseConfig):
    ...
    def algo_config(self):
        ...
        # Skill conditioning (e.g., goal-image VAE latent)
        self.algo.skill_conditioning.enabled = False
        self.algo.skill_conditioning.goal_key = None
        self.algo.skill_conditioning.latent_dim = 64
        self.algo.skill_conditioning.vae_checkpoint = None
        self.algo.skill_conditioning.vae_config_path = None
        self.algo.skill_conditioning.freeze = True
        self.algo.skill_conditioning.normalize_input = True
        self.algo.skill_conditioning.image_size = 256
