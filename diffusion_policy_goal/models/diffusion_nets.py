...
class ConditionalUnet1D(nn.Module):
    ...
    Conditioned on timestep and goal latent
    """
    def __init__(self, 
        input_dim,
        global_cond_dim,
        ...
        Args:
            ...
            global_cond_dim: Dim of global conditioning (goal latent + obs features)
    ...
    def forward(self, 
        ...
        Args:
            ...
            global_cond: (B, global_cond_dim) - goal latent + obs features
        Returns:
